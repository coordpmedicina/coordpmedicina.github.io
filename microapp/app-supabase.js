...
function exportPDF() {
    ...
    printWindow.document.write(`<!DOCTYPE html><html lang="es"><head>
        ...
        <style>
            ...
            .bk-layout { display: block !important; }
            .bk-main { padding: 30px 40px; max-width: 900px; margin: 0 auto; }
            @media print { @page { margin: 2cm; } }
        </style>
    </head><body>${previewHtml}
    <script>setTimeout(()=>{ window.print(); setTimeout(()=>window.close(),500); }, 800);<\/script>
    </body></html>`);
