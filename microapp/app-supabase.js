...
function generatePreview() {
    ...
    const presFields3 = [
        ['Misión del departamento', pres.departmentMission],
        ['Objetivos generales', pres.generalObjectives],
        ['Objetivos específicos', pres.specificObjectives],
        ['Justificación', pres.justification],
        ['Descripción general del curso', pres.generalDescription],
        ['Espacios de asesoría', pres.advisorySpaces],
    ];
