...
function saveCompleteVersion() {
    ...
    localStorage.setItem('microapp_versions', JSON.stringify(savedVersions));
...
function loadFormFromData() {
    ...
    // Cargar más datos aquí según sea necesario
    updateStats();
}

// Cargar versiones al inicializar
function loadVersionsFromStorage() {
    const stored = localStorage.getItem('microapp_versions');
    if (stored) {
        try {
            ...
            momentos: [
                {
                    ...
                    tipos: [
                        ...
                        { id: 113, nombre: 'Elaboración de esquemas', porcentaje: '' },
                        { id: 114, nombre: 'Desarrollo de talleres', porcentaje: '' },
                        { id: 115, nombre: 'Sustentación de esquema integradores', porcentaje: '' },
                        { id: 116, nombre: 'Otras actividades evaluativas', porcentaje: '' }
                    ]
                },
                {
                    ...
                    tipos: [
                        ...
                        { id: 123, nombre: 'Trabajo en grupo', porcentaje: '' },
                        { id: 124, nombre: 'Quíz o evaluación corta', porcentaje: '' },
                        { id: 125, nombre: 'Defensa de tema específico', porcentaje: '' },
                        { id: 126, nombre: 'Otras actividades evaluativas', porcentaje: '' }
                    ]
                },
                {
                    ...
                    tipos: [
                        ...
                        { id: 133, nombre: 'Elaboración de esquemas', porcentaje: '' },
                        { id: 134, nombre: 'Sustentación de esquema integradores', porcentaje: '' },
                        { id: 135, nombre: 'Otras actividades evaluativas', porcentaje: '' }
                    ]
                }
            ]
        },
                    ...
                    cells.push(`<td rowspan="${mRows}" style="${b} vertical-align:middle; text-align:center; background:#f5f8fc; padding:10px 8px;">
                        <div style="display:flex;flex-direction:column;align-items:center;gap:5px;">
                            ...
                            <button onclick="addEvalTipo(${tiempo.id},${momento.id})"
                                    style="background:#e8f6ee; color:#1a7a4a; border:1px solid #a8d8a8; padding:3px 9px; border-radius:4px; font-size:11px; cursor:pointer; font-weight:600; margin-top:2px;">+ Fila</button>
                        </div>
                    </td>`);
                }
