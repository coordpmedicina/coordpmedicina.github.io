                        ...
                        <div style="display:flex;flex-direction:column;align-items:center;gap:5px;">
                            ...
                            <div style="display:flex;gap:4px;margin-top:2px;">
                                <button onclick="addEvalMomento(${tiempo.id})"
                                        style="background:#e8f6ee; color:#1a7a4a; border:1px solid #a8d8a8; padding:3px 9px; border-radius:4px; font-size:13px; cursor:pointer; font-weight:600;" title="Agregar momento">＋</button>
                                <button onclick="deleteEvalTiempo(${tiempo.id})"
                                        style="background:#fee8e8; color:#b02020; border:1px solid #f5b5b5; padding:3px 9px; border-radius:4px; font-size:13px; cursor:pointer; font-weight:600;" title="Eliminar tiempo">×</button>
                            </div>
                        </div>
                    </td>`);
                }
                        ...
                        <div style="display:flex;flex-direction:column;align-items:center;gap:5px;">
                            ...
                            <div style="display:flex;gap:4px;margin-top:2px;">
                                <button onclick="addEvalTipo(${tiempo.id},${momento.id})"
                                        style="background:#e8f6ee; color:#1a7a4a; border:1px solid #a8d8a8; padding:3px 9px; border-radius:4px; font-size:13px; cursor:pointer; font-weight:600;" title="Agregar fila">＋</button>
                                <button onclick="deleteEvalMomento(${tiempo.id},${momento.id})"
                                        style="background:#fee8e8; color:#b02020; border:1px solid #f5b5b5; padding:3px 9px; border-radius:4px; font-size:13px; cursor:pointer; font-weight:600;" title="Eliminar momento">×</button>
                            </div>
                        </div>
                    </td>`);
                }
